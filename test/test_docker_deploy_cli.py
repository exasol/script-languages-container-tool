...
class DockerDeployTest(unittest.TestCase):
    ...
    def test_dockerdeploy_with_path_in_bucket(self):
        ...
        arguments = " ".join(
            [
                f"--bucketfs-host {self.docker_environment.database_host}",
                f"--bucketfs-port {self.docker_environment.ports.bucketfs}",
                f"--bucketfs-user {self.docker_environment.bucketfs_username}",
                ...
                f"--bucketfs-use-https 0",
                f"--release-name {self.release_name}",
            ]
        )
        command = f"{self.test_environment.executable} deploy {arguments}"
    ...
    def test_dockerdeploy_without_path_in_bucket(self):
        self.release_name = "TEST"
        self.bucketfs_name = "bfsdefault"
        self.bucket_name = "default"
        arguments = " ".join(
    ...
    def test_dockerdeploy_fail_path_in_bucket(self):
        self.release_name = "TEST"
        self.bucketfs_name = "bfsdefault"
        self.bucket_name = "default"
        arguments = " ".join(
