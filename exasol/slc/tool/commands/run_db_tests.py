...
def run_db_test(
    ...
    external_exasol_db_host: str | None,
    external_exasol_db_port: int,
    external_exasol_bucketfs_port: int,
    external_exasol_ssh_port: int | None,
    external_exasol_db_user: str | None,
    external_exasol_db_password: str | None,
    external_exasol_bucketfs_write_password: str | None,
    external_exasol_xmlrpc_host: str | None,
    external_exasol_xmlrpc_port: int,
    external_exasol_xmlrpc_user: str,
    external_exasol_xmlrpc_password: str | None,
