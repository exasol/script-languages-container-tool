...
def run_db_test(
    ...
    external_exasol_db_host: str | None = None,
    external_exasol_db_port: int = Ports.external.database,
    external_exasol_bucketfs_port: int = Ports.external.bucketfs_http,
    external_exasol_ssh_port: int | None = None,
    external_exasol_db_user: str | None = None,
    external_exasol_db_password: str | None = None,
    external_exasol_bucketfs_write_password: str | None = None,
    external_exasol_xmlrpc_host: str | None = None,
    external_exasol_xmlrpc_port: int = 443,
    external_exasol_xmlrpc_user: str = "admin",
    external_exasol_xmlrpc_password: str | None = None,
    ...
    use_existing_container: str | None = None,
