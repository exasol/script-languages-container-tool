...
class UploadContainerParameter(ExportContainerOptionsParameter):
    ...
    bucketfs_port: int = luigi.OptionalParameter()  # type: ignore
    ...
    bucket_name: str = luigi.OptionalParameter()  # type: ignore
    ...
    ssl_cert_path: str = luigi.OptionalParameter()  # type: ignore
